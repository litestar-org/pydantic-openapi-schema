...
`Security Schemes <https://spec.openapis.org/oas/v3.1.0#componentsSecuritySchemes>`__ under the `Components Object <https://spec.openapis.org/oas/v3.1.0#componentsObject>`__.
...
`OpenAPI Object <https://spec.openapis.org/oas/v3.1.0#oasObject>`__ or `Operation Object <https://spec.openapis.org/oas/v3.1.0#operationObject>`__,
...
in the `Security Schemes <https://spec.openapis.org/oas/v3.1.0#componentsSecuritySchemes>`__ under the `Components Object <https://spec.openapis.org/oas/v3.1.0#componentsObject>`__.
