...
class Parameter(BaseModel):
    ...
    **REQUIRED**. The name of the parameter.
    ...
    - If `in <https://spec.openapis.org/oas/v3.1.0#parameterIn>`__ is `"path"`, the `name` field MUST correspond to a template expression occurring
      within the `path <https://spec.openapis.org/oas/v3.1.0#pathsPath>`__ field in the `Paths Object <https://spec.openapis.org/oas/v3.1.0#pathsObject>`__.
      See `Path Templating <https://spec.openapis.org/oas/v3.1.0#pathTemplating>`__ for further information.
    - If `in <https://spec.openapis.org/oas/v3.1.0#parameterIn>`__ is `"header"` and the `name` field is `"Accept"`, `"Content-Type"` or `"Authorization"`,
      the parameter definition SHALL be ignored.
    - For all other cases, the `name` corresponds to the parameter name used by the `in <https://spec.openapis.org/oas/v3.1.0#parameterIn>`__ property.
    """
    ...
    **REQUIRED**. The location of the parameter. Possible values are `"query"`, `"header"`, `"path"` or `"cookie"`.
    ...
    If the `parameter location <https://spec.openapis.org/oas/v3.1.0#parameterIn>`__ is `"path"`, this property is **REQUIRED** and its value MUST be `true`.
    ...
    For more complex scenarios, the `content <https://spec.openapis.org/oas/v3.1.0#parameterContent>`__ property
