...
class Encoding(BaseModel):
    ...
    See `Parameter Object <https://spec.openapis.org/oas/v3.1.0#parameterObject>`__ for details on the `style <https://spec.openapis.org/oas/v3.1.0#parameterStyle>`__ property.
    ...
    then the value of `contentType <https://spec.openapis.org/oas/v3.1.0#encodingContentType>`__ (implicit or explicit) SHALL be ignored.
    """
    ...
    When `style <https://spec.openapis.org/oas/v3.1.0#encodingStyle>`__ is `form`, the default value is `true`.
