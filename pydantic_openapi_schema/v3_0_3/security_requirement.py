...
[Security Schemes](https://spec.openapis.org/oas/v3.0.3#componentsSecuritySchemes) under the [Components Object](https://spec.openapis.org/oas/v3.0.3#componentsObject).
...
[OpenAPI Object](https://spec.openapis.org/oas/v3.0.3#oasObject) or [Operation Object](https://spec.openapis.org/oas/v3.0.3#operationObject),
...
in the [Security Schemes](https://spec.openapis.org/oas/v3.0.3#componentsSecuritySchemes) under the [Components Object](https://spec.openapis.org/oas/v3.0.3#componentsObject).
