...
from pydantic_openapi_schema.v3_0_3.components import Components
from pydantic_openapi_schema.v3_0_3.reference import Reference
from pydantic_openapi_schema.v3_0_3.schema import Schema

if TYPE_CHECKING:
    from pydantic_openapi_schema.v3_0_3.open_api import OpenAPI
        ...
        if isinstance(obj, BaseModel):
            ...
            for field in fields:
                ...
                if isinstance(child_obj, PydanticSchema):
                    setattr(obj, field, _construct_ref_obj(child_obj))
